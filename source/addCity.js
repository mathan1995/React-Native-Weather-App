...
class AddCityPage extends Component {
  ...
  renderRow(rowData) {
    ...
    return (
      <TouchableOpacity
        style={{ height: 30, marginLeft: 10, justifyContent: "center" }}
        onPress={() => {
          this.props.navigator.pop();
...
const citySearchBar = StyleSheet.create({
  container: {
    paddingTop: Utilies.isAndroid ? 20 : 0,
    height: 64,
